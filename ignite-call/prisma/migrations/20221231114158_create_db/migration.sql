...
-- AddForeignKey
ALTER TABLE `users_time_intervals` ADD CONSTRAINT `users_time_intervals_user_id_fkey` FOREIGN KEY (`user_id`) REFERENCES `users`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

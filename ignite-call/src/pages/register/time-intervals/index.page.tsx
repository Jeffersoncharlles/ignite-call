...
const timeIntervalsFormSchema = z.object({
  intervals: z
    ...
    .transform(
      (internals) => internals.filter((interval) => interval.enabled), // filtrando e so pegando os que tiver enable true
    ) // transformando ele em outro objetos
    .refine((internals) => internals.length > 0, {
      message: 'você precisa selecionar pelo menos um dia da semana!',
    }) // tem que retornar pelo menos 1
    .transform((internals) => {
...
export default function TimesInterval() {
  ...
  return (
    <>
      ...
      <Container>
        <Header>
          <Heading as="h3">Quase lá</Heading>
          <Text>
